...
If you discover a security issue in RNAmel, please report it **privately**
...
RNAmel is an interactive analysis application meant to run locally, or on a
server you control. In particular:

- **AI-assisted interpretation is opt-in and sends data to a third party.**
  When you enable it and provide an API key, RNAmel sends gene names,
