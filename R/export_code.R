...
#' reproduces the pipeline with RNAmel's public functions -- ready to drop
...
generate_r_script <- function(project,
  ...
  add(sprintf("# RNAmel reproducible analysis script"),
  ...
  # Anchor the figure/enrichment examples on a contrast RNAmel actually
